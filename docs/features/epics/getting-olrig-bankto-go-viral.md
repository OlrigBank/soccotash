...
understand, discover and confidently choose Olrig Bank when searching for
...
The first 47 Olrig Bank reviews support the following proposition:
...
The public accommodation name is **Olrig Bank**. The former public label
**Main House** is retired. Stable internal identifiers such as `main-house` and
`whole-property` may remain where changing them would risk booking, calendar or
historical-data compatibility.

The authoritative public accommodation model is:
...
```text
Olrig Bank — Large Group and Family Holiday House in Kendal
```
...
## Proposed visible Olrig Bank copy
...
Windermere and the wider Lake District are within easy reach, making Olrig Bank
a convenient base for days in the Lakes while retaining the facilities and
transport connections of Kendal.
...
Olrig Bank includes four bedrooms, two bathrooms, a lounge, dining room and
self-catering kitchen. Books, games and children's toys
...
Yes. Olrig Bank has off-road parking and provides guidance for
...
Important pages must link to Olrig Bank through ordinary `<a href>` links
...
5. inspect the Olrig Bank URL and request indexing;
...
└── agent/getting-olrig-bank-to-go-viral-epic
    ...
    ├── agent/pr-97-olrig-bank-search-content
...
2. **PR 97 — Olrig Bank search-intent content and FAQ**
...
1. The stable Olrig Bank URL presents a descriptive title, description, heading
...
3. Important public pages link to Olrig Bank with descriptive, natural
   anchor text.
4. Every indexable public page emits one correct HTTPS canonical URL.
5. Olrig Bank social previews contain correct content and imagery.
