...
export const EXPECTED_ALLOWED_TRANSITIONS: readonly ExpectedTransition[] = Object.freeze([
  ...
  { from: 'payment_pending', action: 'verify_card_payment', actor: 'system', to: 'confirmed', calendarEffect: 'retain', requirements: [] },
  ...
  { from: 'confirmed', action: 'verify_card_balance_payment', actor: 'system', to: 'confirmed', calendarEffect: 'retain', requirements: [] },
